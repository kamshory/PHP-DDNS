...
class Cloudflare
{
   ...
   * @param array  $params
   */
  public function patch($endpoint, $params = array())
  {
   ...
   */
  public function registerDnsZone($name, $params = array())
  {
  ...
  public function setDnsZoneSsl($zoneId, $type)
  {
    ...
    return $this->patch('/zones/' . $zoneId . '/settings/ssl', array('value' => $type));
  }
  ...
  public function setDnsZoneCache($zoneId, $type)
  {
    ...
    return $this->patch('/zones/' . $zoneId . '/settings/cache_level', array('value' => $type));
  }

  public function clearZoneCache($zoneId)
  {
    return $this->delete('/zones/' . $zoneId . '/purge_cache', array('purge_everything' => true));
  }

  public function setDnsZoneMinify($zoneId, $settings)
  {
    return $this->patch('/zones/' . $zoneId . '/settings/minify', array('value' => $settings));
  }

  public function createDnsRecord($zoneId, $type, $name, $content, array $params = array())
  {
